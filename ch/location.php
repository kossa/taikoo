<?php include_once 'header.php'; ?>
    ...
    <section class="location">
      ...
      <div class="line line-01">
        <div class="first">
          <div class="wrapper">
            <h4>太古坊栢舍位於繁盛的鰂魚涌臨海商業區，商業、娛樂及文化設施配套完善；甲級商廈、特色露天餐廳、時尚酒吧、藝術展覽、文化活動等式式俱備。</h4>
            <p>住戶可步行前往港島最大型的購物商場──太古城中心，商場內薈萃170多家時尚名店、美食廣場、大型超市、戲院及世界級滑冰賽事和表演的熱門場地「太古城中心冰上皇宮」，集購物、飲食、娛樂及消閒於一身。</p>
            <p>項目的地理位置優越，配備完善交通網絡，與港鐵太古站和鰂魚涌站只是幾步之遙，瞬間直達港九各區。綠意盎然的鰂魚涌海濱公園和附設步行徑的翠綠山巒近在咫尺，讓住戶欣賞大自然景色，優質生活不假外求。</p>
          </div>
        </div>
        <div class="second">
        </div>
